...
export const TRANSLATIONS = {
  en: {
    ...
    allVibes: 'All vibes',
    logisticsFilterLabel: 'Terrain you can walk',
    hardConstraintNote: 'Hard requirement — never relaxed',
    anyLogistics: 'No requirement',
    logisticsStepFree: 'Step-free, stroller & wheels',
    logisticsCobblestones: 'Cobblestones, but no stairs',
    logisticsStairs: 'Stairs & steep climbs are fine',
  ...
  ru: {
    ...
    logisticsFilterLabel: 'Рельеф, который вам подходит',
    hardConstraintNote: 'Жесткое требование — не смягчается',
    anyLogistics: 'Без ограничений',
    logisticsStepFree: 'Без ступеней, с коляской',
    logisticsCobblestones: 'Брусчатка, но без лестниц',
    logisticsStairs: 'Лестницы и подъемы не помеха',
