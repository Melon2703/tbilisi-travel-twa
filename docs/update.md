PROJECT_MASTER_SPEC.md — UI Refactor & Route Spec
...
+---------------------------------------------------+
| [X] Old Tbilisi Walking Route               [...] |
+---------------------------------------------------+
|                                                   |
|            [ LOCATION HEAD PHOTO ]                |
|                                                   |
| ┌──────────────────────────────────────────────┐  |
| │  Google Maps 4.8/5  │  Yandex Maps 4.9/5   │  | <-- Deep links to map apps
| └──────────────────────────────────────────────┘  |
+---------------------------------------------------+
| STOP 4 OF 19
| Gabriadze Puppet Theater & Clock
| 
| Recommended Timing: 11:45 AM - 12:15 PM
|  
| OLYA'S LOCAL TIP
| ┌──────────────────────────────────────────────┐  |
